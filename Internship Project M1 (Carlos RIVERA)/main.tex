...
\begin{figure}[!h]
    ...
    \captionsetup{justification=centering}
    \caption{Laser frequency control instrumentation scheme at the beginning of the project.} %Before the corrections?
    \label{fig:schematic}
\end{figure}
...
%Step 3:
\begin{step}
As per trabucayre's "redpitaya" github repository \cite{trabucayre}, we must setup the "BR2\_EXTERNAL" variable to the location where the "redpitaya" directory is, as show in listing \ref{lst:br2_external}, to provide Buildroot based support for Red Pitaya (12, 14, and 16 bits) board.
...
In the middle of the compilation there was an error fetching the file "linux-xilinx-v2019.1.tar.gz" from the internet, which is why it was copied from the \textit{Other computer} directly (lising \ref{lst:linux-xilinx}).
...
% \begin{figure}[h!]
% 	\centering
% 	\includegraphics[width=0.5\textwidth]{Images/Laser_Servo_loop_flowchart.pdf}
% 	\caption{.}
% 	\label{fig:test}
% \end{figure}
% \end{wrapfigure}
...
%     % \vspace{-10pt}
%     % \centering
% % \usebox{\laserAnimation}
% \animategraphics[controls={play,step},width=0.5\textwidth,autoplay,loop]{2}{animation_laser_servo_loop/laser1_}{0}{50}
% %     \captionsetup{justification=centering}
% %     \caption{.}
% %     \label{fig:}
% \end{wrapfigure}
...
%     % \vspace{-10pt}
%     % \centering
% % \usebox{\quartzAnimation}
% \animategraphics[controls={play,step},width=0.5\textwidth,autoplay,loop]{2}{animation_quartz_servo_loop/quartz_}{0}{61}
% %     \captionsetup{justification=centering}
% %     \caption{.}
% %     \label{fig:}
% \end{wrapfigure}
